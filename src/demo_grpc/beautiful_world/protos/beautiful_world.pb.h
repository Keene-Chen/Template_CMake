...
#ifndef beautiful_5fworld_2eproto_2epb_2eh
#define beautiful_5fworld_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_beautiful_5fworld_2eproto
...
struct TableStruct_beautiful_5fworld_2eproto {
...
/* @@protoc_insertion_point(class_definition:beautiful_world.HelloRequest) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "beautiful_world.HelloRequest"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:beautiful_world.HelloRequest)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_beautiful_5fworld_2eproto;
};
// -------------------------------------------------------------------

class HelloReply final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:beautiful_world.HelloReply) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "beautiful_world.HelloReply"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:beautiful_world.HelloReply)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
inline const std::string& HelloRequest::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:beautiful_world.HelloRequest.name)
...
inline PROTOBUF_ALWAYS_INLINE void HelloRequest::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:beautiful_world.HelloRequest.name)
}
inline std::string* HelloRequest::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:beautiful_world.HelloRequest.name)
  return _s;
}
...
inline std::string* HelloRequest::release_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:beautiful_world.HelloRequest.name)
...
inline void HelloRequest::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:beautiful_world.HelloRequest.name)
}
...
inline const std::string& HelloReply::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:beautiful_world.HelloReply.message)
...
inline PROTOBUF_ALWAYS_INLINE void HelloReply::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:beautiful_world.HelloReply.message)
}
inline std::string* HelloReply::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:beautiful_world.HelloReply.message)
  return _s;
}
...
inline std::string* HelloReply::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:beautiful_world.HelloReply.message)
...
inline void HelloReply::set_allocated_message(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:beautiful_world.HelloReply.message)
}
...
#endif  // beautiful_5fworld_2eproto_2epb_2eh
