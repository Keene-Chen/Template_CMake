...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_async_5fgrpc_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_async_5fgrpc_2eproto = nullptr;
const ::uint32_t
    TableStruct_async_5fgrpc_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::async_grpc::HelloRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::async_grpc::HelloRequest, _impl_.name_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::async_grpc::HelloReply, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::async_grpc::HelloReply, _impl_.message_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::async_grpc::HelloRequest)},
        {9, -1, -1, sizeof(::async_grpc::HelloReply)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::async_grpc::_HelloRequest_default_instance_._instance,
    &::async_grpc::_HelloReply_default_instance_._instance,
};
const char descriptor_table_protodef_async_5fgrpc_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\020async_grpc.proto\022\nasync_grpc\"\034\n\014HelloR"
    "equest\022\014\n\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007me"
    "ssage\030\001 \001(\t2\344\001\n\007Greeter\022>\n\010SayHello\022\030.as"
    "ync_grpc.HelloRequest\032\026.async_grpc.Hello"
    "Reply\"\000\022K\n\023SayHelloStreamReply\022\030.async_g"
    "rpc.HelloRequest\032\026.async_grpc.HelloReply"
    "\"\0000\001\022L\n\022SayHelloBidiStream\022\030.async_grpc."
    "HelloRequest\032\026.async_grpc.HelloReply\"\000(\001"
    "0\001b\006proto3"
};
static ::absl::once_flag descriptor_table_async_5fgrpc_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_async_5fgrpc_2eproto = {
    false,
    false,
    330,
    descriptor_table_protodef_async_5fgrpc_2eproto,
    "async_grpc.proto",
    &descriptor_table_async_5fgrpc_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_async_5fgrpc_2eproto::offsets,
    file_level_enum_descriptors_async_5fgrpc_2eproto,
    file_level_service_descriptors_async_5fgrpc_2eproto,
};
namespace async_grpc {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:async_grpc.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::async_grpc::HelloRequest& from_msg)
...
HelloRequest::HelloRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:async_grpc.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:async_grpc.HelloRequest)
  SharedDtor(*this);
}
...
const ::google::protobuf::internal::ClassDataFull HelloRequest::_class_data_ = {
    ...
    &descriptor_table_async_5fgrpc_2eproto,
    nullptr,  // tracker
};
...
const ::_pbi::TcParseTable<0, 1, 0, 36, 2> HelloRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::async_grpc::HelloRequest>(),  // to_prefetch
  ...
  {{
    "\27\4\0\0\0\0\0\0"
    "async_grpc.HelloRequest"
    "name"
  }},
};

PROTOBUF_NOINLINE void HelloRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:async_grpc.HelloRequest)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloRequest::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:async_grpc.HelloRequest)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_name().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "async_grpc.HelloRequest.name");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:async_grpc.HelloRequest)
          return target;
        }
        ...
        ::size_t HelloRequest::ByteSizeLong() const {
          const HelloRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:async_grpc.HelloRequest)
          ::size_t total_size = 0;
...
void HelloRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:async_grpc.HelloRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:async_grpc.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:async_grpc.HelloReply)
}
inline PROTOBUF_NDEBUG_INLINE HelloReply::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::async_grpc::HelloReply& from_msg)
...
HelloReply::HelloReply(
  ...
  // @@protoc_insertion_point(copy_constructor:async_grpc.HelloReply)
}
inline PROTOBUF_NDEBUG_INLINE HelloReply::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
HelloReply::~HelloReply() {
  // @@protoc_insertion_point(destructor:async_grpc.HelloReply)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<0, 1, 0, 37, 2> HelloReply::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::async_grpc::HelloReply>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string message = 1;
    {::_pbi::TcParser::FastUS1,
  ...
  {{
    "\25\7\0\0\0\0\0\0"
    "async_grpc.HelloReply"
    "message"
  }},
};

PROTOBUF_NOINLINE void HelloReply::Clear() {
// @@protoc_insertion_point(message_clear_start:async_grpc.HelloReply)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloReply::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:async_grpc.HelloReply)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_message().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "async_grpc.HelloReply.message");
            target = stream->WriteStringMaybeAliased(1, _s, target);
          }
          ...
          // @@protoc_insertion_point(serialize_to_array_end:async_grpc.HelloReply)
          return target;
        }
        ...
        ::size_t HelloReply::ByteSizeLong() const {
          const HelloReply& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:async_grpc.HelloReply)
          ::size_t total_size = 0;
...
void HelloReply::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:async_grpc.HelloReply)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:async_grpc.HelloReply)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_async_5fgrpc_2eproto),
         ::std::false_type{});
